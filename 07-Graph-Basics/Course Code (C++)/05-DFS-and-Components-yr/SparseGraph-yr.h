...
public:
    SparseGraph(int vertexNum, bool directed);
    ~SparseGraph();
    ...
    public:
        adjIterator(SparseGraph &g, int a): graph(g){
            search_vertex = a;
            index = 0;
        }
...
SparseGraph::SparseGraph(int vertexNum, bool directed){
    this->vertexNum = vertexNum;
    this->edgeNum = 0;   // 开始边的数量为0
